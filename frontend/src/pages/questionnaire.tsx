...
const QuestionnairePage: React.FC = () => {
  ...
  const carbonIntensity = formData.totalRevenue > 0 ? formData.carbonEmissions / formData.totalRevenue : 0;
  const renewableElectricityRatio = formData.totalElectricityConsumption > 0 ? 
    (formData.renewableElectricityConsumption / formData.totalElectricityConsumption) * 100 : 0;
  const diversityRatio = formData.totalEmployees > 0 ? 
    (formData.femaleEmployees / formData.totalEmployees) * 100 : 0;
  const communitySpendRatio = formData.totalRevenue > 0 ? 
    (formData.communityInvestment / formData.totalRevenue) * 100 : 0;

  const validateForm = (): boolean => {
    const newErrors: ValidationErrors = {};

    // Environmental validations
    if (formData.renewableElectricityConsumption > formData.totalElectricityConsumption) {
      newErrors.renewableElectricityConsumption = 'Renewable consumption cannot exceed total consumption';
    }

    // Social validations
    if (formData.femaleEmployees > formData.totalEmployees) {
      newErrors.femaleEmployees = 'Female employees cannot exceed total employees';
    }

    if (formData.averageTrainingHours < 0) {
      newErrors.averageTrainingHours = 'Training hours cannot be negative';
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // TODO: Implement API call to save ESG data
  ...
  const getInputClass = (fieldName: string) => {
    const baseClass = "w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#BBE8E1] focus:border-[#BBE8E1]";
      ...
      <div className="min-h-screen bg-gradient-to-br from-[#BBE8E1] via-white to-[#F5CD6B] py-8">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">Complete your sustainability assessment for the financial year</p>
          </div>
          ...
          <div className="bg-white/90 shadow-xl rounded-2xl p-8">
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="space-y-6">
                ...
                <p className="text-gray-600">Track your organization's environmental impact.</p>
                
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      Total Electricity Consumption * <span className="text-red-500">*</span>
                    </label>
                    <input
                      type="number"
                      ...
                      className={getInputClass('totalElectricityConsumption')}
                      placeholder="0.00"
                      min="0"
                      step="0.01"
                    />
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      Renewable Electricity Consumption * <span className="text-red-500">*</span>
                    </label>
                    <input
                      type="number"
                      ...
                      onChange={handleInputChange}
                      className={getInputClass('renewableElectricityConsumption')}
                      placeholder="0.00"
                      min="0"
                      step="0.01"
                    />
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      Total Fuel Consumption * <span className="text-red-500">*</span>
                    </label>
                    <input
                      type="number"
                      ...
                      onChange={handleInputChange}
                      className={getInputClass('totalFuelConsumption')}
                      placeholder="0.00"
                      min="0"
                      step="0.01"
                    />
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      Carbon Emissions * <span className="text-red-500">*</span>
                    </label>
                    <input
                      type="number"
                      ...
                      onChange={handleInputChange}
                      className={getInputClass('carbonEmissions')}
                      placeholder="0.00"
                      min="0"
                      step="0.01"
                    />
                    <span className="text-sm text-gray-500">T CO2e</span>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-6">
                ...
                <p className="text-gray-600">Measure your organization's social impact and workforce diversity.</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      className={getInputClass('totalEmployees')}
                      placeholder="0"
                      min="0"
                    />
                  </div>
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      Number of Female Employees * <span className="text-red-500">*</span>
                    </label>
                    <input
                      type="number"
                      ...
                      onChange={handleInputChange}
                      className={getInputClass('femaleEmployees')}
                      placeholder="0"
                      min="0"
                    />
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      Average Training Hours * <span className="text-red-500">*</span>
                    </label>
                    <input
                      type="number"
                      ...
                      onChange={handleInputChange}
                      className={getInputClass('averageTrainingHours')}
                      placeholder="0.0"
                      min="0"
                      step="0.1"
                    />
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      Community Investment * <span className="text-red-500">*</span>
                    </label>
                    <input
                      type="number"
                      ...
                      onChange={handleInputChange}
                      className={getInputClass('communityInvestment')}
                      placeholder="0.00"
                      min="0"
                      step="0.01"
                    />
              ...
              <div className="space-y-6">
                ...
                <p className="text-gray-600">Assess your organization's governance practices and transparency.</p>
                
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      % of Independent Board Members * <span className="text-red-500">*</span>
                    </label>
                    <input
                      type="number"
                      ...
                      onChange={handleInputChange}
                      className={getInputClass('independentBoardMembers')}
                      placeholder="0.0"
                      min="0"
                      max="100"
                      step="0.1"
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleInputChange}
                      className={getInputClass('hasDataPrivacyPolicy')}
                    >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      className={getInputClass('totalRevenue')}
                      placeholder="0.00"
                      min="0"
                      step="0.01"
                    />
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-2">
                  ...
                  <h2 className="text-xl font-semibold text-gray-900">Auto-Calculated Metrics</h2>
                  <span className="text-sm text-gray-500 bg-gray-100 px-2 py-1 rounded">Real-time calculation</span>
                </div>
                <p className="text-gray-600">These metrics are automatically calculated based on your inputs.</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <span className="text-sm text-gray-500">T CO2e / INR</span>
                  </div>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <div className="text-2xl font-bold text-gray-900">
                      {renewableElectricityRatio.toFixed(2)}
                    </div>
                    <span className="text-sm text-gray-500">%</span>
                  </div>
...
export default withAuth(QuestionnairePage, { title: "ESG Questionnaire - Oren" });
